...
public class TileManager {
    ...
    private void creatingTiles() {
        ...
        tiles.add(R_WATER = new Tile(ImgFix.getRotImg(getSprite(6, 0), 90), id++, "R_Water"));
        tiles.add(B_WATER = new Tile(ImgFix.getRotImg(getSprite(6, 0), 180), id++, "B_Water"));
        tiles.add(L_WATER = new Tile(ImgFix.getRotImg(getSprite(6, 0), 270), id++, "L_Water"));
        //Water corner
